    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Tambah Pengguna Aplikasi</h5>
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <br>
                  <input type="checkbox" name="level_id" value="1">
                  <label for=""> Administrator</label>
                  <input type="checkbox" name="level_id" value="3">
                  <label for=""> Petugas</label>
                  <input type="checkbox" name="level_id" value="2">
                  <label for=""> Dokter</label>
                  <input type="checkbox" name="level_id" value="4">
